    ...
    <div className="min-h-screen bg-[#0b0f1a] pt-32 pb-20 px-4">
      <div className="max-w-md mx-auto bg-gray-900/40 border border-white/10 p-8 rounded-[40px] backdrop-blur-xl shadow-2xl">
        ...
        <p className="text-gray-400 text-center mb-8 text-sm font-medium">
          Change your identity in the gamehub world
        </p>

        <form onSubmit={handleUpdate} className="space-y-6">
          {/* Name */}
          <div>
            <label className="text-gray-400 text-xs font-bold uppercase tracking-widest ml-1 mb-2 block">
              Display Name
            </label>
            <input
              type="text"
          ...
          <button
            type="submit"
            className="w-full bg-cyan-400 hover:bg-cyan-500 text-gray font-black py-4 rounded-2xl transition-all shadow-lg shadow-cyan-400/20 active:scale-95"
          >
            Save Changes
          </button>
        </form>
